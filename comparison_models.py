...
# ---------- Load data ----------
df = pd.read_csv("data/all_models_evaluated.csv")  # Adjust path if needed
...
for _, row in df.iterrows():
    ...
    # Commons (entity present in at least two models)
...
width = 0.85  # bar width slightly less than 1 to avoid overlap
